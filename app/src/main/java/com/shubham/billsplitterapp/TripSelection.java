...
//      For Transparent Status bar uncomment below line
        ...
        myDb = new DatabaseHelper(TripSelection.this);
        ...
        final Button addTripBtn = findViewById(R.id.add_trip_btn);
        addTripBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                tripNameTextView = findViewById(R.id.tripName);
                TextView warningTextView = findViewById(R.id.warningText_tripSelection);
